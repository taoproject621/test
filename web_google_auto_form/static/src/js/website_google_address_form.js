odoo.define('web_google_auto_form.address_form_autocomplete', function (require) {
    'use strict';
            ...
            country.onchange = function () {
                ...
                if (country_id) {
                    rpc.query({
                        model: "res.country",
                        method: 'read',
                        args: [parseInt(country_id), ['code']],
                        context: {}
                    }).then(function (result) {
                        self.initAutocomplete([result[0]['code']]);
                    });
...
odoo.define('web_google_auto_form.website_sale_form', function (require) {
    'use strict';

    require('web.dom_ready');
    var GooglePlacesAutocomplete = require('web_google_auto_form.address_form_autocomplete');
